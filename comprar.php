...
<div class="buy-shell">
  ...
  <div class="buy-card">
    ...
    <ul class="buy-includes">
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12l5 5 11-11"/></svg><span>12 módulos, 29 videoaulas práticas + apostila com referências oficiais Microsoft</span></li>
