const COURSE_DETAILS = {
  ...
  'modelagem-pratica': [
    { h: 'Entrega rápida: um modelo que filtra corretamente', p: 'Reserve 20 minutos. Importe uma tabela de vendas e uma tabela de produtos, crie o relacionamento Produto 1:* Vendas e monte uma tabela visual com Produto e Faturamento. O objetivo não é criar um dashboard bonito: é comprovar que a dimensão filtra a fato e que o total não duplica.' },
    { h: 'Critério de pronto', items: ['A dimensão Produto possui uma linha por produto.', 'A fato Vendas pode repetir ProdutoID.', 'O relacionamento mostra 1:* e filtro em direção única.', 'Cada produto exibe um valor diferente quando possui vendas diferentes.', 'O total confere com a soma da fonte.', 'Você consegue explicar o que cada linha das duas tabelas representa.'] },
    { h: 'Evidência do resultado', p: 'Salve o arquivo como Primeiro-Modelo-Power-BI.pbix e tire uma captura da exibição Modelo. Esse pequeno artefato é sua primeira entrega do curso e servirá como comparação quando o modelo final estiver pronto.' },
